...
public class LabyrintheImpl2 extends UnicastRemoteObject implements Labyrinthe {
	...
	public void initLabyrinthe() {
		//Création des pièces
		lesPieces.put("A1", new Piece("A1", "Gravalanche", idServeur, true));
		lesPieces.put("A2", new Piece("A2", "Virgo", idServeur, false));
		lesPieces.put("A3", new Piece("A3", "Wizzel", idServeur, false));
		lesPieces.put("B1", new Piece("B1", "Zabro", idServeur, true));
		lesPieces.put("B2", new Piece("B2", "Stanis", idServeur, false));
		lesPieces.put("B3", new Piece("B3", "Logos", idServeur, false));
		lesPieces.put("C1", new Piece("C1", "Saturos", idServeur, true));
		lesPieces.put("C2", new Piece("C2", "Vaglor", idServeur, false));
		lesPieces.put("C3", new Piece("C3", "Aeron", idServeur, false));
	}
	...
	public boolean seDeplacer(Joueur j, char direction) throws RemoteException {
		...
		if (deplace == true && nbJoueurs == 0){ 
			...
			LabyrintheImpl2 lab = new LabyrintheImpl2();
